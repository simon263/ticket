...
public class FrmUser extends javax.swing.JFrame {
    ...
    private void btnModifierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModifierMouseClicked
        if(tblTickets.getSelectedRowCount()==0){
            JOptionPane.showMessageDialog(this,"selectionner une ligne a modifier");
        }
        else{
            int a = Integer.parseInt(tblTickets.getValueAt(tblTickets.getSelectedRow(),0).toString());
            int cbo = fm.GetIdEtat(cboEtatsTickets.getSelectedItem().toString());
            fm.ModifierEtatTicket(a,cbo);
